...
sim_args = {
    ...
    'num_cores':1,
    'entropy_objective': 'max'
}

sim_mod = Simulation_transfer_entropy(**sim_args)    
data1 = {}
data2 = {}
perf1 = sim_mod.compute_performance(agent_pair_genome, 0, data1)
print('perf1: {}'.format(perf1))
perf2 = sim_mod.compute_performance(agent_pair_genome, 0, data2)
