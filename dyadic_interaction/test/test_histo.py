...
sim_mod = Simulation_histo_entropy(**sim_args)    
data1 = {}
data2 = {}
perf1 = sim_mod.compute_performance(agent_pair_genome, data1)
print('perf1: {}'.format(perf1))
perf2 = sim_mod.compute_performance(agent_pair_genome, data2)
