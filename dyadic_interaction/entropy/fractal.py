...
def petrosian_fd(x):
    ...
    * Goh, Cindy, et al. "Comparison of fractal dimension algorithms for
    ...
    --------
    >>> import numpy as np
    >>> from dyadic_interaction.entropy import petrosian_fd
    >>> np.random.seed(123)
...
def katz_fd(x):
    ...
    * Goh, Cindy, et al. "Comparison of fractal dimension algorithms for
    ...
    --------
    >>> import numpy as np
    >>> from dyadic_interaction.entropy import katz_fd
    >>> np.random.seed(123)
    >>> x = np.random.rand(100)
    >>> print(katz_fd(x))
    5.121395665678078
...
def higuchi_fd(x, kmax=10):
    ...
    --------
    >>> import numpy as np
    >>> from dyadic_interaction.entropy import higuchi_fd
    >>> np.random.seed(123)
    >>> x = np.random.rand(100)
    >>> print(higuchi_fd(x))
    2.0511793572134467
...
def detrended_fluctuation(x):
    ...
    * R. Hardstone, S.-S. Poil, G. Schiavone, R. Jansen,
    ...
    --------
    >>> import numpy as np
    >>> from dyadic_interaction.entropy import detrended_fluctuation
    >>> np.random.seed(123)
    >>> x = np.random.rand(100)
